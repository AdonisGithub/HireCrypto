...
const Discord = () => {
  return (
    <div>
      <div className="w-full relative flex bg-[#182037]  pt-[105px] pb-4 justify-center" id="Discord">
        <div className="w-full">
          ...
          <div className=" min-w-full">
            ...
            ></img>
            <div className="hidden md:flex justify-center w-full absolute md:top-[25px] lg:top-[86px] text-center font-bold font-sans text-white text-[38px]  mb-1">
              Join The 
            </div>
            <div className="hidden md:flex justify-center w-full absolute md:top-[65px] lg:top-[128px] text-center font-bold font-sans text-white text-[38px] mb-1">
              HireCrypto Community
            </div>
            <div className="hidden md:flex flex   justify-center">
              <a
                ...
                className="flex justify-center"
              >
                <button className="flex justify-center absolute  md:top-[128px] lg:top-[200px] shrink-0 px-4 py-1 font-semibold border border-transparent hover:border-gray-200 text-[30px] text-white active:text-red-600 bg-[#385d94] hover:bg-transparent rounded-md">
                  Discord
                </button>
              </a>
            </div>
